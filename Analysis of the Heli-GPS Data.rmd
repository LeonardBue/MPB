...
```{r fig:freq_species_19_20_21_cum, fig.align = 'center', out.width = "50%", fig.cap = 'Frequency how often each tree species was the most dominant within one cell for each area of interest and cumulative.'}
